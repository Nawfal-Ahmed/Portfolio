...
const PROJECTS = [
  {
    ...
    desc: "A real-time competitive coding arena where developers can host lobbies, challenge peers, and write/execute code against test cases in a race against the clock. Features persistent WebSockets, active session recovery, and dynamic sandbox execution.",
    tags: ["React", "Node.js", "Express", "Socket.io", "MongoDB", "Tailwind CSS"],
    color: "#8b5cf6",
    icon: "⚡",
    github: "https://github.com/Nawfal-Ahmed/ClashOfCodes",
    live: "https://clash-of-codes-ten.vercel.app/",
  },
  {
...
const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    skills: ["Node.js", "Express.js", "Django", "Socket.io", "REST APIs"],
  },
  {
  ...
  },
  {
    ...
    skills: ["MongoDB", "SQL", "Git", "Tableau"],
  },
  {
